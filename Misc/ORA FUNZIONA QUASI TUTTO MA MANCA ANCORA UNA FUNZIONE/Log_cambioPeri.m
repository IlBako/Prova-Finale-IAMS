function [dv, theta_3, theta_4, dt] = Log_cambioPeri(a, e, w_i, w_f, theta_i, mu, k)
    ...
    M = [k w_i w_f dw theta_3_a theta_3_b dv dt_a dt_b theta_4];
    writematrix(M, "Log_peri.xls", "WriteMode","append");
